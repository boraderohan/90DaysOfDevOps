...
![Task-Compose-version](./image/Docker-compose-version.png)
...
![Task-3-](./image/Docker_compose_two_conatainer.png)
![Task-3-ps](./image/Docker_compose_Docker_ps.png)
...
![Task-5-env](./image/Docker-env-folder.png)
![Task-5-variable-picked](./image/Docker-variable-picked.png)
